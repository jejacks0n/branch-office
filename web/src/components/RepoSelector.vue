        ...
        >
          <div class="flex items-center gap-3 min-w-0 pr-2">
            ...
            <div class="min-w-0 flex-1">
              ...
              <div v-if="repo.branch" class="mt-1 flex items-center gap-1.5">
                <span
                  class="inline-flex items-center gap-1 text-[11px] font-mono px-2 py-0.5 rounded-md bg-zinc-800 text-zinc-300 border border-zinc-700/60 shrink-0"
                >
                  <GitBranch class="w-3 h-3 text-emerald-400" />
                  <span class="truncate max-w-[200px]">{{ repo.branch }}</span>
                </span>
              </div>
          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <span
              ...
              class="text-xs font-semibold px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20"
            >
              {{ repo.dirtyCount }} changed
            </span>
            <span
              v-else-if="repo.clean"
              class="text-[11px] font-medium px-2 py-0.5 rounded-full bg-zinc-800 text-zinc-400"
            >
              clean
            </span>
